<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态" clearable>
          <el-option
            v-for="dict in dict.type.park_status"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="parkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="停车场名字" align="center" prop="name" />
      ...
      <el-table-column label="状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.park_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="收费规则" prop="ruleId">
          <el-select v-model="form.ruleId" placeholder="请输入收费规则" clearable
          >
          </el-select>
        </el-form-item>
      </el-form>
...
<script>
import { listPark, getPark, delPark, addPark, updatePark } from "@/api/park/park";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除停车场编号为"' + ids + '"的数据项？').then(function() {
        return delPark(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('park/park/export', {
        ...this.queryParams
