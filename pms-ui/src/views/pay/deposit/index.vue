<template>
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="depositList">
...
export default {
  ...
  methods: {
    ...
    loadPayFeeItemByType() {
      getPayFeeItemByType('deposit').then(res => {
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if(this.form.id!=null){
            updateDeposit(this.form).then(res=>{
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('pay/deposit/export', {
        ...this.queryParams
