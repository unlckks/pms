<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="商圈编号" prop="code">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['asset:block:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table border v-loading="loading" :data="blockList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="编号" align="center" prop="id" />
      <el-table-column label="商圈编号" align="center" prop="code" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="商圈编号" prop="code">
          <el-input v-model="form.code" placeholder="请输入商圈编号" />
        </el-form-item>
        <el-form-item label="商圈名称" prop="name">
...
<script>
import { listBlock, getBlock, delBlock, addBlock, updateBlock } from "@/api/asset/houseBlock";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        code: [
          { required: true, message: "商圈编号不能为空", trigger: "blur" }
        ],
        name: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除商圈管理编号为"' + ids + '"的数据项？').then(function() {
        return delBlock(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('asset/block/export', {
        ...this.queryParams
